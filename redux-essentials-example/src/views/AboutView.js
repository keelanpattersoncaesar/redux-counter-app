...
const AboutView = () => {
    return (
    <div className='font-Roboto text-center bg-gradient-to-r from-orange-200 to-red-300 min-h-screen'>
      <h1 className='text-7xl mb-10'>About Fruit Counter</h1>
        <div className='flex flex-row p-10 m-10'>
         ...
         <CardContainer string={"TailWind CSS"} text={"This application uses Tailwind CSS for it's styling. Tailwind is a CSS framework that incorporates in-line styling for rapidly building custom user interfaces."} />
        </div>  
    </div>  
    )
}
